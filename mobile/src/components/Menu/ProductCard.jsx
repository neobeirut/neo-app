...
import { getStatusColor, calculateDiscountedPrice } from "@/utils/menuHelpers";
...
export function ProductCard({
  ...
  // Best-effort hint from API (some screens also compute this separately)
          ...
          {!canAddToCart ? (
            ...
            >
              ...
              <TouchableOpacity
                ...
                onPress={(e) => {
                  e.stopPropagation();
                  onAddToCart(product, { hasCustomizations });
                }}
