...
export function getProductsForBranch(
  ...
  // Create a map of product statuses, prices, and inventory from productStatusData
  ...
  // Map products with their branch-specific status and filter out only "Hide from Menu" products
...
export function getDiscountedProducts(products, categories, selectedSection) {
  return products.filter((product) => {
    ...
    // Check if product belongs to selected section
